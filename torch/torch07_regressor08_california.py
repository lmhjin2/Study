...
print(x.shape, y.shape)  # (20640, 8) (20640,) // torchTensor 는 .shape가 파란색, numpy는 하얀색
...
print(x_train.shape, y_train.shape)  # (16512, 8) (16512, 1) // torchTensor 는 .shape가 파란색, numpy는 하얀색
...
# ==================================================
# 최종 loss : 0.3441283702850342
# rmse : 0.5866245564967718
# r2 : 0.6950303256677364
