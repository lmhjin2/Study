...
# 최종 예측 및 정확도 계산
y_pred = torch.argmax(model(x_test), dim=1).cpu().detach().numpy()
score = accuracy_score(y_test.cpu().numpy(), y_pred)
print(f'accuracy : {score}')

result = model(x_test[0].unsqueeze(0))
print(f"x_test[0] 예측값 : {result.argmax().item()}")

# ==================================================
# 최종 loss : 0.6716330419191967
# f1 : 0.7282858490943909
# ACC : 0.7282858490943909
# accuracy : 0.728285844599537
