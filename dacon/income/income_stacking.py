...
cbt = CatBoostRegressor(n_estimators=1000, learning_rate=0.014795, random_seed=9)
...
stacking = StackingRegressor(
    estimators=base_models, final_estimator=meta_model, cv=kfold
)
# 3
...
submission.to_csv("c:/Study/dacon/income/output/0406_ens.csv", index=False)
