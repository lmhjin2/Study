...
for index, row in test.iterrows():
    ...
    messages = [
        ...
        {"role": "user", "content": f"input : {query}, output : "},
    ]
...
submission = pd.read_csv(
    "c:/data/dacon/kor_restore/sample_submission.csv", encoding="utf-8-sig"
)
submission["output"] = restored_reviews
submission.to_csv(
    "c:/data/dacon/kor_restore/output/submission2.csv",
    index=False,
    encoding="utf-8-sig",
)
