...
param_search_space = {
    'n_estimators': [548,549],
    # 'criterion' : ['gini'],
    'max_depth': [None,77,78],
    'min_samples_split': [4,5],   # 2이상의 정수 또는 0과 1사이의 실수(비율)
    'min_samples_leaf': [6,7],    # 1이상의 정수 또는 0과 0.5 사이의 실수(비율)
    'min_weight_fraction_leaf' : [0.0, 0.12689089332817577, 0.1],     # 0.0 ~ 0.5 실수
