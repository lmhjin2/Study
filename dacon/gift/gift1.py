...
distance_df = pd.DataFrame(
    distance_matrix, index=data["point_id"], columns=data["point_id"]
)
...
while not remaining_points.empty:
    ...
    feasible_points = remaining_points[
        remaining_points["demand"] <= current_capacity
    ].copy()
    ...
    remaining_points = remaining_points[
        remaining_points["point_id"] != nearest_point["point_id"]
    ].copy()
