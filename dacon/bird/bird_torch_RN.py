...
train, val, _, _ = train_test_split(
    df, df["label"], test_size=0.3, stratify=df["label"], random_state=CFG["SEED"]
)
...
train_dataset = CustomDataset(
    [os.path.join(train_img, img_name) for img_name in train["img_path"].values],
    train["label"].values,
    train_transform,
)
...
val_dataset = CustomDataset(
    [os.path.join(train_img, img_name) for img_name in val["img_path"].values],
    val["label"].values,
    test_transform,
)
...
test_dataset = CustomDataset(
    [os.path.join(test_img, img_name) for img_name in test["img_path"].values],
    None,
    test_transform,
)
