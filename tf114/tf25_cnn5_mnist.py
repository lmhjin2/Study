...
L1 += b1    # L1 = L1 + b1
L1 = tf.nn.relu(L1)
L1 = tf.nn.dropout(L1, keep_prob=0.7)  # keep_prob는 남길 비율, rate는 날릴 비율
...
b2 = tf.compat.v1.Variable(tf.compat.v1.zeros([64], name = 'b2'))
...
b4 = tf.compat.v1.Variable(tf.compat.v1.zeros([100], name='b4'))
