...
train_df['img_path'] = train_df['img_path'].apply(lambda x: os.path.join('/home/aia/Study/dacon/bird/', x))
train_df['upscale_img_path'] = train_df['upscale_img_path'].apply(lambda x: os.path.join('/home/aia/Study/dacon/bird/', x))
le = LabelEncoder()
