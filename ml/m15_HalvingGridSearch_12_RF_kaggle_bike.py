...
# 최적의 매개변수 :  RandomForestRegressor(max_depth=8, min_samples_leaf=7, n_estimators=200)
# 최적의 파라미터 :  {'max_depth': 8, 'min_samples_leaf': 7, 'n_estimators': 200}
# best_score : 0.3478835446330488
# model.score : 0.344046946285834
# r2_score: 0.344046946285834
# 최적 튠 R2: 0.344046946285834
# 걸린시간: 60.52 초