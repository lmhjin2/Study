...
parameters = [
    {'randomforestclassifier__n_estimators':[100,200,300], 'randomforestclassifier__max_depth':[6,8,10,12], 'randomforestclassifier__min_samples_leaf':[3,5,7,10]},
...
# 파라미터에 모델 이름을 소문자로 풀네임 + '_'두개 붙여야함 == 귀찮음
