...
parameters = [
    {"C":[1,10,100,1000], "kernel":["linear"], "degree":[1,2,3,4,5,6]},   # 12
    {"C":[1,10,100,1000], "kernel":["rbf"], "gamma":[1, 0.1, 0.01, 0.001, 0.0001]},    # 6
    {"C":[1,10,100,1000], "kernel":["sigmoid"],                     # 24
    "gamma":[1, 0.1, 0.01, 0.001, 0.0001], "degree":[1,2,3,4,5,6]}                  # 다더해서 42*5 = 210. kfold 5배
]
