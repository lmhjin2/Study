...
model.fit(x_train, y_train, 
          ...
          # eval_metric='rmse', # 기본값  //  r2
          # eval_metric='mae',  # rmsle, mape, mphe..등등  //  r2
          # eval_metric='error',  # 이진분류  //  r2 돌아가긴함. 결과 bad
          # eval_metric='merror',  # 다중분류  //  error
          # eval_metric='logloss', # 원래 알기는 이진분류, 다중분류?  //  r2
          # eval_metric='auc',  # 모든 분류  //  r2 돌아가긴함. 결과 bad
          # eval_metric='aucpr', #  //  r2 돌아가긴함. 결과 bad
          )
