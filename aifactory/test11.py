...
model.load_weights("c:/Study/aifactory/dataset/pt/kumar-roy/unet_16f_2conv_762/model_unet_Kumar-Roy_final_weights.h5")
model.compile(optimizer = Adam(), loss = 'binary_crossentropy', metrics = ['accuracy', sm.metrics.iou_score, miou])
# model.summary()
