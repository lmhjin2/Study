...
result = model.predict('d:/_data/coco/archive (1)/coco2017/train2017/000000000009.jpg', conf = 0.5)    # confidence 0.5이상만 박싱
folder_path ='c:/study/datasets/coco8/images/val/'
# print(results)  # 탐지한 객체의 정보가 담김. (x,y,w,h), Class ID ? , confidence == 최종지표 mAP
