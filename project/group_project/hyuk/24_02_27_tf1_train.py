...
pickle.dump(tokenizer.get_vocabulary(), open(BASE_PATH + 'vocab_coco.file', 'wb'))

# x= pickle.load(open(BASE_PATH + 'vocab_coco.file', 'rb'))
...
# 가중치 저장
caption_model.save_weights('c:/_data/project/save/caption_model.h5')
