...
#2
model = Sequential()
model.add(Conv2D(16, (2,2), input_shape=(4,2,1), 
                 padding='same',
                 activation='sigmoid'))
model.add(Conv2D(32, (4,2), padding='same', activation='relu'))
...
# CNN
# r2: 0.3498683777256977
# loss : [21210.08203125, 106.90357971191406, 21210.08203125, 1.7424705028533936]
# run time: 40.12
