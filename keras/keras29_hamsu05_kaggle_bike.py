...
dense1 = Dense(160, activation='relu')(input1)
dense2 = Dense(126, activation='relu')(dense1)
dense3 = Dense(92, activation='relu')(dense2)
dense4 = Dense(48, activation='relu')(dense3)
...
mcp = ModelCheckpoint(monitor='val_loss',mode='auto',
    ...
    filepath='c:/_data/_save/MCP/keras26_MCP_05_kaggle_bike.hdf5')
