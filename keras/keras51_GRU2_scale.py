...
#2 
model = Sequential()
# model.add(GRU(26, input_shape = (3,1)))
model.add(Bidirectional(GRU(26), input_shape = (3,1)))
model.add(Dense(32))
model.add(Dense(10))
model.add(Dense(13))
model.add(Dense(9))
...
# loss 0.00012248443090356886
# [[79.48068]]

# loss 6.239015056053177e-05
# [[78.513954]]
