...
#2
model = Sequential()
model.add(Conv2D(9, kernel_size=(2,2), strides=2, # strides=보폭 / strides로 딱 못나누면 나머지는 버림. 
                 input_shape = (28, 28, 1), padding='same',activation='relu')) # (n, 27, 27, 9)
model.add(Conv2D(filters= 10, kernel_size=(3,3),input_shape=(27,27,9))) # (n, 25, 25, 10) # (3*3*9+1)*10  
