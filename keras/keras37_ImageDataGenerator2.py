...
# 정수와 부동소수점의 연산이라 부동소수점의 연산으로 데이터형태 변환
...
#2
model = Sequential()
model.add(Conv2D(3, (23,23), input_shape = (200,200,3),
                 activation='sigmoid'))
model.add(Conv2D(2, (20,20), padding='valid', activation='relu'))
model.add(Dropout(0.3))
model.add(Conv2D(2, (25,25), padding='valid', activation='relu'))
model.add(Dropout(0.2))
model.add(Conv2D(3, (30,30), padding='valid', activation='relu'))
model.add(MaxPooling2D())
model.add(Dropout(0.3))
model.add(Conv2D(1, (17,17), padding='valid', activation='relu'))
model.add(Dropout(0.2))
model.add(MaxPooling2D())
model.add(Flatten())
...
# loss [0.6906149387359619, 0.8999999761581421]
# acc 0.9
# run time 4.51
