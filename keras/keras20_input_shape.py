...
model = Sequential()
# model.add(Dense(26, input_dim = 13))    # metrics 형태. tensor 형태면 input_shape
model.add(Dense(10, input_shape = (13,)))   # input_shape 로 vector 13개를 인풋으로 넣은거.
model.add(Dense(52))        # (10000, 10, 10, 3) 이었으면 input_shape = (10, 10, 3)이됨 // 행무시
model.add(Dense(25))
model.add(Dense(50))
model.add(Dense(13))
model.add(Dense(1))
