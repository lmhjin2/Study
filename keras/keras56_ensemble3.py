...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test, y1_train, y1_test, y2_train, y2_test = train_test_split(
    x1_datasets, x2_datasets, x3_datasets, y1, y2, train_size = 0.7, random_state = 0 )
...
model.fit([x1_train, x2_train, x3_train], [y1_train, y2_train], epochs = 5000, batch_size = 1, verbose = 1, callbacks=[es])
