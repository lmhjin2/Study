...
x1_train, x1_test, x2_train, x2_test, y_train, y_test = train_test_split(
    x1_datasets, x2_datasets, y, train_size = 0.7, random_state = 0 )
...
# 2-3 concatenate
merge1 = concatenate([output1, output11], name = 'mg1')     # 이건 소문자
...
model.fit([x1_train, x2_train], y_train, epochs = 5000, batch_size = 1, verbose = 1, callbacks=[es])
