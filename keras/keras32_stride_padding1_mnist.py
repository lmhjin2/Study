...
model.add(Conv2D(10, kernel_size=(3,3), activation='relu')) # (n, 25, 25, 10) # (3*3*9+1)*10  
model.add(Conv2D(15, (4,4), padding='same', activation='relu')) # (n, 22, 22, 15)  # (a,a)일때 a-1개 만큼 (n, b, b, c) b에서 빠짐.
model.add(Flatten())
