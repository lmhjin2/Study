...
#2
model = Sequential()
model.add(Conv2D(26, (2,2), input_shape=(5,2,1), padding='same',
                 activation='sigmoid'))
model.add(Conv2D(12, (2,2), padding='same', activation='relu'))
...
# CNN
# loss: [4106.1435546875, 4106.1435546875, 0.18867990374565125, 49.18598175048828]
# RMSE: 64.07919841211933
# RMSLE: 0.43437300930134215
# run time: 48.11
